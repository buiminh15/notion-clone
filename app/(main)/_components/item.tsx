...
function Item(props: IItemProps) {
  const { label, icon: Icon, onClick, active, documentIcon, isSearch, level = 0, onExpand, expanded, id } = props
          ...
          <div className='ml-auto flex items-center gap-x-2'>
            <DropdownMenu>
              <DropdownMenuTrigger asChild onClick={(e) => e.stopPropagation()}>
                <div role='button' className='opacity-0 hover:opacity-100 h-full ml-auto rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600'>
